...
const contactFormSchema = z.object({
  ...
  projectDescription: z.string().nonempty("Please enter a subject"),
  projectBudget: z.string().nonempty("Please enter a message"),
});
          ...
          <Form {...contactForm}>
            <form onSubmit={onSubmit} className="space-y-8">
              ...
              <FormField
                ...
                render={({ field, fieldState, formState }) => (
                  <FormItem>
                    <FormLabel>projectDescription</FormLabel>
                    <FormControl>
                      <Input
              ...
              <FormField
                ...
                render={({ field, fieldState, formState }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        placeholder={"Let us work together for the price of:"}
                        {...field}
                      />
                    </FormControl>
                    <FormDescription>
                      This is how much you intend to cover the cost of
                      development in USD.
                    </FormDescription>
                    <section className="hidden">
                      <FormMessage>{fieldState.error?.message}</FormMessage>
