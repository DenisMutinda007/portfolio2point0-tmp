...
export default function Home() {
  return (
    <div className="text-foreground bg-background min-h-screen z-0">
      ...
      <SkillSet />
      <EducationAndWork />
      <section id="projects" className="resume border-t-2 border-foregroundbg-background text-foreground pb-2">
        <div className="resume-content px-5">
          <div className="resume-intro text-center pb-5">
            ...
            <p className="text-lg">
              ...
              to work with and what they had to say of their experience of
              working with me.
            </p>
          </div>
              ...
              <div className="testimonial bg-gray-100 flex flex-col w-11/12 mx-auto my-3 rounded-xl px-2 md:flex-row">
                ...
                <div className="words flex flex-col ml-3 pt-1 my-auto md:w-4/5">
                  <p className="review text-gray-900 font-semibold text-lg">
                    ...
                    Over the course of multiple projects I&apos;ve worked with
                    him on, his diligence, commitment and expertise have
                    continuously proved invaluable in ensuring the timely
                    delivery of said projects while always maintaining his
                    characteristic quality standards. He is quite the fast
                    learner and his intellectual curiosity is perhaps one of the
                    most priceless assets he brings into any developer team.
                    <span className="text-3xl">”</span>
                  </p>
              ...
              <div className="testimonial bg-gray-100 flex flex-col w-11/12 mx-auto my-3 rounded-xl px-2 md:flex-row">
                ...
                <div className="words flex flex-col ml-3 pt-1 my-auto md:w-4/5">
                  <p className="review text-gray-900 font-semibold text-lg">
                    ...
                    helpful in guiding through the whole process and overall, I
                    am beyond pleased with Denis&apos;s impeccable service.
                    <span className="text-3xl">”</span>
                  </p>
                  <figcaption className="pl-5 text-lg font-medium p-1 md:flex md:justify-between">
                    <div className="left">
